...
/**
 * Concrete SpaceEnemy implementation of a laser shooting space enemy.
 * @author Izzy Carlson
 */
public class LaserAlien implements SpaceEnemy {
    int health;
    int attackDamage;
    ...
    /**
     * Constructor to initialize the laser shooting space enemy. Ensures health and attack damage are valid.
     ...
     */
    public LaserAlien(int health, int attackDamage, String spawnText){
        ...
        this.image = new ImageIcon("src/Images/Puzzle4/P4_LaserAlien.png").getImage();
    }
